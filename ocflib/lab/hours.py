...
HOLIDAYS = [
    ...
    (date(2017, 11, 16), date(2017, 11, 16), 'Early Lab Closure for Job/Internship Search Workshop', [Hour(time(9), time(18))]),
    (date(2017, 11, 22), date(2017, 11, 26), 'Thanksgiving Break', []),
    (date(2017, 11, 30), date(2017, 11, 30), 'Early Lab Closure for Interview Workshop', [Hour(time(9), time(18))]),
