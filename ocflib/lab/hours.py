...
REGULAR_HOURS = defaultdict(lambda: [], {
    Day.MONDAY: [Hour(time(9), time(18))],
    Day.TUESDAY: [Hour(time(11), time(15))],
    Day.WEDNESDAY: [Hour(time(9), time(19))],
    Day.THURSDAY: [Hour(time(9), time(19))],
    Day.FRIDAY: [Hour(time(9), time(16))],
})
