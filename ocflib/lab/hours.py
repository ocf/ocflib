...
HOLIDAYS = [
    ...
    (date(2017, 5, 8), date(2017, 5, 8), 'Finals Week',
     [Hour(time(10, 10), time(18))]),
    (date(2017, 5, 9), date(2017, 5, 9), 'Finals Week',
     [Hour(time(11, 10), time(17))]),
    (date(2017, 5, 10), date(2017, 5, 10), 'Finals Week',
     [Hour(time(11, 10), time(18))]),
    (date(2017, 5, 11), date(2017, 5, 11), 'Finals Week',
     [Hour(time(9, 10), time(12))]),
